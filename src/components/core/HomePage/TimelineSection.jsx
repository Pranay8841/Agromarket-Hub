...
const TimeLine = [
    {
        ...
        Description: "Highest quality products for farming needs.",
    },
    {
        Logo: Logo2,
        Heading: "Customer Satisfaction",
        Description: "Exceeding expectations for ultimate satisfaction.",
    },
    {
        Logo: Logo3,
        Heading: "Sustainable Practices",
        Description: "Promoting sustainability for a better future.",
    },
    {
        Logo: Logo4,
        Heading: "Expert Advice",
        Description: "Valuable support for farming endeavors.",
    },
];
                            ...
                            <div className="flex flex-col lg:gap-3" key={i}>
                                ...
                                <div
                                    className={`hidden ${TimeLine.length - 1 === i ? "hidden" : "lg:block"
                                        }  h-14 border-dotted border-r border-richblack-700 bg-richblack-600/0 w-[26px]`}
                                ></div>
                            </div>
                        );
                    })}
