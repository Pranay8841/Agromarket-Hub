...
const Footer = () => {
  return (
    <div className="bg-richblue-500 border-t border-t-richblue-300">
      <div className="flex lg:flex-row gap-8 items-center justify-between w-11/12 max-w-maxContent text-richblack-200 leading-6 mx-auto relative py-14">
        <div className="border-b w-[100%] flex flex-col lg:flex-row pb-5 border-richblue-300">
          {/* Section 1 */}
          <div className="lg:w-[50%] flex flex-wrap flex-row justify-between lg:border-r lg:border-richblue-300 pl-3 lg:pr-5 gap-3">
